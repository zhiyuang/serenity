...
public:
    ...
    void stroke_path(Path const&, Color, float thickness, Path::StrokeLinecap linecap = Path::StrokeLinecap::Round);
    void stroke_path(Path const&, PaintStyle const& paint_style, float thickness, float opacity = 1.0f, Path::StrokeLinecap linecap = Path::StrokeLinecap::Round);
